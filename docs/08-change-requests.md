...
| CR-20 | 结局页重构成「Uncle 人设卡」（截图货币） | P1 | screens.js / style.css | ✅ 已完成（人设身份为视觉主角 + 评级/天数金色副标签 + 战绩 chip + kopitiam；实机截图存活/破产两卡） |
| CR-21 | 特殊需求第二批：道德两难 | P0 | data.js / sim.js | ✅ 已完成（美食家挑刺/学生求便宜/老伯赊账；花钱型两难"拒绝不扣分"保持中性；请求走派生子 rng 不扰平衡流；约 1/4 顾客带需求；平衡带守住；73 测试绿）。**去掉"塞红包"——新加坡廉洁语境不存在** |
